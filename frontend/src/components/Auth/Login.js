...
export default function Login() {
  ...
  const handleSubmit = async e => {
    ...
    if (res && res.message && (res.message.toLowerCase().includes('not approved') || res.message.toLowerCase().includes('not approved by admin'))) {
      setError('Your account is not approved by admin yet. Please wait for approval.');
    } else if (res && res.message && !res.token) {
    ...
    <Box minHeight="100vh" display="flex" alignItems="center" justifyContent="center" sx={{ position: 'relative', zIndex: 1 }}>
      ...
      <Fade in timeout={800}>
        ...
        >
          ...
          {success && (
            <Box mb={2} width="100%">
              <Typography variant="body1" color="success.main" align="center" fontWeight={600}>
                {success}
              </Typography>
            </Box>
          )}
          ...
          <Typography variant="h4" fontWeight={700} textAlign="center" mb={1} color="primary">Welcome Back</Typography>
          ...
          >
            ...
            <Button
              ...
              sx={{
                ...
                fontSize: 18,
                py: 1.5,
                '&:hover': { background: 'linear-gradient(90deg, #e0c3fc 0%, #8ec5fc 100%)' },
              }}
              fullWidth
            >
            ...
            <Typography variant="body2" textAlign="center" mt={2}>
              Don't have an account? <Link to="/register" style={{ color: '#9c27b0', fontWeight: 500 }}>Register here</Link>
            </Typography>
          </form>
        </Box>
      </Fade>
