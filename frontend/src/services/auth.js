const API_URL = process.env.REACT_APP_API_URL || 'https://medicare-v.vercel.app//api/auth';
const DELIVERY_API_URL = process.env.REACT_APP_API_URL || 'https://medicare-v.vercel.app//api/delivery';
